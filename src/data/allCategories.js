// filepath: c:\Users\Administrator\Desktop\正在做\VueToolDirectory\src\data\categories\allCategories.js
// 所有工具分类数据的合并文件

// 定义默认图标路径，可在整个应用中复用
export const defaultToolIcon = '/icons/tool-icon-placeholder.png';
...
export const featuredTools = [
    ...
    },
    {
        ...
        icon: '/icons/ali-ai-ecommerce.png',
